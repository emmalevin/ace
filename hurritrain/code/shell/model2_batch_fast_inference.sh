...
#SBATCH --output=/scratch/gpfs/GVECCHI/el2358/ace/hurritrain/slurm/model2_inf_%A_%a.out
...
YAML_FILE=/scratch/gpfs/GVECCHI/el2358/ace/hurritrain/code/yaml/model2_fast_inference.yaml
