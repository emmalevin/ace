...
srun /usr/local/bin/nsys profile -o timeline_output_training_m1 --force-overwrite true --trace cuda,nvtx,osrt torchrun  --master_port=$MASTER_PORT --nproc_per_node=2 \
